...
the $\Z$-module $R=\Z+\Z i$ then $(1+i)R$ is generated *over $\Z$* by $1+i$ and $(1+i)i=i-1$; it is not cyclic as a $\Z$-module. 
...
**Proof:** If $m_1$ and $m_2$ are torsion, $r_1 m_1=0$ and $r_2 m_2=0$, with both $r_1$ and $r_2$ nonzero,  then $r_1 r_2 (m_1+m2)=0$ and $r_1 r_2 (m_1 m_2)=0$, 
and $r_1 r_2$ is nonzero since $R$ is an integral domain.
